...
/*    private double minX1;
    ...
    public GraphicsDisplay()
    {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {15,3,3,3,8,3,3,3}, 0.0f);
...
//            char[] ch = in.toCharArray();
            canvas.setColor(Color.BLACK);
            if (point[1] <= (int)point[1].doubleValue()+0.1 && point[1] >= (int)point[1].doubleValue() - 0.1  ) {
            	canvas.setColor(Color.RED);
            }
...
//            canvas.fill(marker);
            ...
            element.moveTo(lineEnd.getX() , lineEnd.getY() - 6);
            element.lineTo(element.getCurrentPoint().getX() - 6, element.getCurrentPoint().getY() +12);
            element.lineTo(element.getCurrentPoint().getX() +12, element.getCurrentPoint().getY());
            element.lineTo(element.getCurrentPoint().getX() - 6, element.getCurrentPoint().getY() -12);
